...
| **Cohort** / **Maniple** | Gemini(손) — 조사·1차 반론 / 병렬 팬아웃(다수 코호트 소집 = 스웜) |
| **Servitor** | Gemini(손) — 대량 실행·기계적 수정·요약(단순 노역) |
| **Servo-skull** | 감시·기록 드론 — 스케줄 작업(세션 폴링·업데이트 확인)이 관찰해 Datavault에 기록 |
